...
# Exemple
original = [2,41,31,96527525,4,98545,284152515,666,88]
compressed = compress_cross(original)
decompressed = decompress_cross(compressed)
print("Original     :", original)
print("Compressé    :", compressed)
print("Décompressé  :", decompressed)
res=[]
for i in range(len(original)):
    res.append(cross_get(compressed,i+1))
